...
public class KeyFinderService {
    ...
    private final String END_OF_CODE_TAG = "**********endOfCodeTag**********";
...
//        this.arrayOfSingleWords = printValueLessList;
    ...
    private void initArrayOfSingleWordsForPlagiarism() {
        this.arrayOfSingleWordsForPlagiarism = arrayOfLinesToArrayOfSingleWords(this.arrayOfLinesOfSingleWordsForPlagiarism);
    }
    ...
    private void initVariablesFromArrayOfSingleWord() {
        List<String> target = this.arrayOfSingleWordsForPlagiarism;
    ...
    private void initParamsFromArrayOfSingleWord() {
        ...
        for (List<String> line: this.arrayOfLinesOfSingleWordsForPlagiarism){
...
//
//        System.out.println("depth = " + keyFinderService.maxDepthOfFunction(keyFinderService.getArrayOfFunctionBodyByNames().get("set_addresses")));
